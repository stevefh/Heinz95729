namespace Moviq.Domain.Cart.Tests
{
    ...
    using Moviq.Locale;
    using Moviq.Domain.Products.Tests;
    using RestSharp;
    using Moq;
    ...
    [TestClass]
    public class CartRepositoryFixture
    {
        public CartRepositoryFixture()
        {
            // Fixture setup
        ...
        [TestMethod]
        [TestCategory("CartRepository, when Get is executed with a valid Id, it")]
        public void should_return_a_cart_with_the_given_id()
        {
            // given
        ...
        [TestMethod]
        [TestCategory("CartRepository, when AddToCart is executed with a valid Id, it")]
